...
Glib::ustring OptionComboBox::Row::get_text() const
{
...
bool OptionComboBox::Row::get_sensitive() const
{
...
Glib::ustring OptionComboBox::get_active_text() const
{
	Glib::ustring text;
...
int OptionComboBox::get_active_index() const
{
