...
void Dialog_Partition_Info::Display_Info()
{
	...
	{
		// Members
		grid->attach(*Utils::mk_label("<b>" + Glib::ustring(_("Members:")) + "</b>", true, false, false, 0.0 /* ALIGN_START */),
		              1, top, 1, 1);
	...
	{
		// Logical Volumes
		grid->attach(*Utils::mk_label("<b>" + Glib::ustring(_("Logical Volumes:")) + "</b>", true, false, false, 0.0 /* ALIGN_START */),
		              1, top, 1, 1);
