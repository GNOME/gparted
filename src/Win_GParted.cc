...
Win_GParted::Win_GParted( const std::vector<Glib::ustring> & user_devices )
{
	...
	try {
		// Gtk CSS specification is different for Gtk3 < 3.20 and >= 3.20.
		// See: https://developer.gnome.org/gtk3/stable/ch32s10.html
                                  ...
                                  )
{
	...
	if ( error != NULL )
	{
		...
		// TODO
		//
		// We can make use of g_desktop_app_info_new () to launch yelp by its desktop file.
		// For that, see: https://developer.gnome.org/gtk3/stable/gtk-migrating-2-to-3.html#id-1.6.3.3.7
		// Example:
		//
