...
public:
	...
	static Gtk::Image* mk_image(const Glib::ustring& icon_name, Gtk::IconSize icon_size);
	static Glib::RefPtr<Gdk::Pixbuf> mk_pixbuf(const Glib::ustring& icon_name, Gtk::IconSize icon_size);
